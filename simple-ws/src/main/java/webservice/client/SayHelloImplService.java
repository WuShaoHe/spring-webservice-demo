 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://server.webservice/", wsdlLocation = "http://127.0.0.1:8088/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://server.webservice/", "SayHelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8088/hello?wsdl");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://server.webservice/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservice/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
